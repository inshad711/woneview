...
const ContactSection = () => {
  ...
  return (
    <section className="templateContainer">
      <div id="contact" className="py-12 md:py-24 px-0 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="flex flex-col items-center text-center">
            <div className="text-center mb-4">
              ...
              <p
                ...
                style={{ color: "rgb(99, 99, 99)" }}
              >
                Tools, strategies, and updates for teams scaling ESG and climate
                reporting
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div
                ...
                style={{
                  backgroundColor: "rgb(246, 246, 246)",
                  boxShadow:
                    "0px 2px 4px rgba(0,0,0,0.02), 0px 50px 30px -2.5px rgba(204, 204, 204, 0.13)",
                }}
              >
                <div
                ...
                <p
                  ...
                  style={{ color: "rgb(99, 99, 99)" }}
                >
                  Have questions, ideas, or feedback? We’d love to hear from
                  you. Our team usually replies within 1–2 business days.
                </p>
                <a
                  href="mailto:hello@emitra.com"
                  className="text-lg font-semibold border-b border-black/10 hover:border-black transition-all inline-block"
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "rgb(99, 99, 99)" }}
                >
                  Need help with your project or want to discuss ideas? We’re
                  here to support you.
                </p>
                <a
                  href="tel:+1554328821"
            ...
            >
              ...
              <div className="pt-2">
                <button
                  ...
                  style={{
                    backgroundColor: "rgb(1, 71, 36)",
                    boxShadow:
                      "inset 0px 0px 20px 1.64px rgba(255, 255, 255, 0.16), 0px 50px 30px -2.5px rgba(24, 66, 42, 0.13)",
                  }}
                >
                  Send Message
                </button>
              ...
              >
                ...
                our team. Your data stays private — no spam.
              </p>
            </form>
          </div>
        </div>
