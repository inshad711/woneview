...
const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    content:
      "We're having an excellent experience using their whatsapp and google review apps on our websites.",
    source: "google",
    avatar:
  ...
  },
  {
    ...
    rating: 5,
    content:
      "I’ve been using these widgets for a few years now. I’m fully satisfied with the features, price, and support. It makes our workflow so much faster.",
    source: "google",
    avatar:
  ...
  },
  {
    ...
    title: "Easy Setup, Exceptional Support",
    content:
      "I think Elfsight is super easy to install and use right out of the box. It only takes a few minutes to install on any website and embed it. I really like their customer service...",
    source: "g2",
    avatar:
  ...
  },
  {
    ...
    rating: 5,
    content:
      "Here in Australia, we have been using Elfsight for 12 Months, and we are very impressed with its integration and ease of setup and use.",
    source: "g2",
    avatar:
  ...
  },
  {
    ...
    rating: 5,
    content:
      "The best tool for social proof. Our conversion rate increased by 15% after adding the review widget.",
    source: "google",
    avatar:
  ...
  },
  {
    ...
    rating: 5,
    content:
      "Incredible value for money. The interface is clean and the widgets are highly customizable to match our branding.",
    source: "google",
    avatar:
  ...
  },
  {
    ...
    content:
      "I've tried many different platforms, but this one is by far the most stable and easiest to manage.",
    source: "g2",
    avatar:
  ...
  },
  {
    ...
    rating: 5,
    content:
      "Technical support answered within 10 minutes and solved my CSS issue immediately. 5 stars!",
    source: "g2",
    avatar:
    ...
    <div className="min-w-[350px] max-w-[350px] bg-white rounded-[12px] p-8 flex flex-col h-[320px] shrink-0 border border-gray-100 shadow-sm transition-all hover:shadow-md">
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h4 className="text-[#111827] font-bold text-[17px] leading-tight">
              {review.author}
            </h4>
            <p className="text-gray-500 text-sm mt-0.5">{review.date}</p>
          </div>
      ...
      <div className="flex flex-col">
        {review.title && (
          <h5 className="text-gray-900 font-bold text-base mb-2 leading-snug">
            {review.title}
          </h5>
        )}
        <p className="text-[#4B5563] text-[16px] leading-[1.6] line-clamp-5 overflow-hidden">
      ...
      <section className="pt-20 px-4 md:px-8 max-w-[1440px] mx-auto overflow-hidden">
        <div className="text-center mb-4">
          ...
          <motion.p
            ...
            className="text-lg text-[#1D322D]/70 max-w-2xl mx-auto"
          >
            Tens of thousands of reviews and multiple awards prove why companies
            worldwide rely on Elfsight.
          </motion.p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 mb-8">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <img
              src="https://elfsight.com/wp-content/themes/elfsight/frontend/assets/img/rating-google.svg"
              alt="Google"
              className="h-10 w-auto"
            />
            <img
              src="https://elfsight.com/wp-content/themes/elfsight/frontend/assets/img/rating-g2.svg"
              alt="G2"
              className="h-10 w-auto"
            />
            <img
              src="https://elfsight.com/wp-content/themes/elfsight/frontend/assets/img/rating-trustpilot.svg"
              alt="Trustpilot"
              className="h-10 w-auto"
            />
          </div>
        ...
        <div className="relative group max-w-[100vw]">
          ...
          <button
            onClick={() => scroll("left")}
            className={`absolute -left-2 top-1/2 -translate-y-1/2 z-40 p-4 rounded-full bg-white shadow-2xl border border-gray-100 transition-all flex items-center justify-center hover:bg-gray-50 active:scale-95 ${
              !canScrollLeft
          ...
          <button
            onClick={() => scroll("right")}
            className={`absolute -right-2 top-1/2 -translate-y-1/2 z-40 p-4 rounded-full bg-white shadow-2xl border border-gray-100 transition-all flex items-center justify-center hover:bg-gray-50 active:scale-95 ${
              !canScrollRight
                ? "text-gray-300 cursor-not-allowed"
                : "text-gray-900 cursor-pointer"
            }`}
