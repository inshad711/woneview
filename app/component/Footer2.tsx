        ...
        <footer className="bg-[#151619] text-white pt-20 md:pt-32 pb-12 px-8 md:px-16 border relative overflow-hidden m-3 rounded-[20px]">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
                    ...
                    <div className="md:col-span-4 space-y-4">
                        <p className="text-gray-300 font-semibold text-[13px] leading-relaxed max-w-xs">
                            Woneview diversified its business from energy cables to power cables by
                            engaging in manufacturing of Cable Laying Equipment & Accessories.
                        </p>
                        ...
                        <div className="space-y-3 pt-4">
                            <div className="flex items-center gap-3">
                                <Phone className="h-4 w-4 text-gray-200 shrink-0" />
                                <a href="tel:+912235111968" className="text-gray-200 hover:text-white transition-colors text-[13px]">
                                    +91 22 35111968
                                </a>
                            </div>
                            <div className="flex items-center gap-3">
                                <Phone className="h-4 w-4 text-gray-200 shrink-0" />
                                <a href="tel:+919769085565" className="text-gray-200 hover:text-white transition-colors text-[13px]">
                                    +91 9769085565
                                </a>
                            </div>
                            <div className="flex items-center gap-3">
                                <Mail className="h-4 w-4 text-gray-200 shrink-0" />
                                <a href="mailto:info@woneview.com" className="text-gray-200 hover:text-white transition-colors text-[13px]">
                                    info@woneview.com
                                </a>
                            </div>
                        </div>
