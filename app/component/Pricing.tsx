            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="relative flex items-center p-1 bg-black/5 rounded-full border border-black/15 w-64">
                        ...
                        <button
                            onClick={() => setBillingCycle('monthly')}
                            className={`relative flex-1 cursor-pointer z-10 px-4 py-2.5 text-sm font-semibold transition-colors duration-200 ${billingCycle === 'monthly' ? 'text-white' : 'text-zinc-500'
                                }`}
                        >
                            Monthly
                        </button>
                        <button
                            onClick={() => setBillingCycle('yearly')}
                            className={`relative flex-1 cursor-pointer z-10 px-4 py-2.5 text-sm font-semibold transition-colors duration-200 ${billingCycle === 'yearly' ? 'text-white' : 'text-zinc-500'
                                }`}
                        >
                            Yearly
                        </button>
