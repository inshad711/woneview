...
const reviews = [
  ...
  },
  {
    ...
    comment:
      "Whoever's editing your videos now... they deserve a raise this was smooth af",
  },
  {
    id: 3,
    username: "@johnbai",
  ...
  },
  {
    ...
    comment:
      "This feels super polished now. Loving the new vibe — your editor is killing it",
  },
];
...
const ReviewCard = ({ review, index }: { review: any; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="sticky w-full bg-white rounded-[12px]  p-6 border border-gray-300 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.05)] flex gap-4 items-start"
    >
      <img
        src={review.avatar}
        alt={review.username}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4 mt-2">
          ...
          <span className="text-xs font-bold text-gray-400 cursor-pointer hover:text-black">
            Reply
          </span>
        </div>
      </div>
    ...
    <div className="templateContainer">
      <div className="bg-[#FDFDFD] text-[#171717] selection:bg-orange-100 ">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Main Content Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-5 md:gap-20 items-start">
            ...
            <div className="sticky top-10 w-full max-w-[380px]">
              ...
              <div className="bg-gradient-to-r from-[#f15b2b] to-gray-400 rounded-[32px] overflow-hidden shadow-2xl pt-14 flex flex-col items-center">
